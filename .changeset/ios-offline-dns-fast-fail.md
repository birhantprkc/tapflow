...
Only outbound UDP is allowed. TCP on the same port stays blocked — it already failed immediately, so opening it would buy nothing and would let a device you took offline hold a connection to anything listening there.
